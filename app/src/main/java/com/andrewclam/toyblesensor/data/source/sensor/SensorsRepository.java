 ...
 * local and remote types of {@link SensorDataSource}
 */

@Singleton
public class SensorsRepository extends Repository<Sensor> implements SensorDataSource {

  @NonNull
  private final SensorDataSource mLocalDataSource;

  @NonNull
  private final SensorDataSource mRemoteDataSource;

  @VisibleForTesting
  @Inject
  SensorsRepository(@NonNull @Local SensorDataSource localDataSource,
                    @NonNull @Remote SensorDataSource remoteDataSource) {
